...
import co.ankit.demomvp.presenter.MainPresenter;
import co.ankit.demomvp.util.MockModelFabric;
import co.ankit.demomvp.view.MainMvpView;
...
public class MainPresenterTest {
    ...
    @Before
    public void setUp() {
        DemoApplication application = (DemoApplication) RuntimeEnvironment.application;
